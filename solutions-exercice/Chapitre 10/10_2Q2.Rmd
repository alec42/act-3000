...
&= C_\alpha^{Clayton}\big( F_{X_1}(x_1),  F_{X_2}(x_2)\big)
\end{aligned}
$$
...
&= 1 - \overline{F}_{X_2}(x_2) - C_\alpha^{Clayton}\big( F_{X_1}(x_1),  \overline{F}_{X_2}(x_2)\big)
\end{aligned}
$$
...
```{r}
FXX <- function(x1, x2) {
     1 - pexp(x1, 1 / 100, lower.tail = FALSE) - densityCopule(pexp(x1, 1 / 100), 1 -
...
&= 1 - \overline{F}_{X_1}(x_1) - C_\alpha^{Clayton}\big( \overline{F}_{X_1}(x_1), F_{X_2}(x_2)\big)
\end{aligned}
$$
...
&= 1 - \overline{F}_{X_1}(x_1) \overline{F}_{X_2}(x_2) + C_\alpha^{Clayton}\big( \overline{F}_{X_1}(x_1), \overline{F}_{X_2}(x_2)\big)
\end{aligned}
$$

...
&= C_\alpha^{Frank}\big( F_{X_1}(x_1),  F_{X_2}(x_2)\big)
\end{aligned}
$$
...
-1 / alpha * log(1 + ((exp(-alpha * u1) - 1) * (exp(-alpha * u2) - 1) /
(exp(-alpha) - 1)))
}
...
&= 1 - \overline{F}_{X_2}(x_2) - C_\alpha^{Frank}\big( F_{X_1}(x_1),  \overline{F}_{X_2}(x_2)\big)
\end{aligned}
$$
...
&= 1 - \overline{F}_{X_1}(x_1) - C_\alpha^{Frank}\big( \overline{F}_{X_1}(x_1), F_{X_2}(x_2)\big)
\end{aligned}
$$
...
&= 1 - \overline{F}_{X_1}(x_1) \overline{F}_{X_2}(x_2) + C_\alpha^{Frank}\big( \overline{F}_{X_1}(x_1), \overline{F}_{X_2}(x_2)\big)
\end{aligned}
$$
